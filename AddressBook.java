    ...
    public static void searchBook(){
        ...
        if (choice == 1){
            ...
            for (int i = 0; i<Book.size(); i++) {
                ...
                if(i==Book.size()-1 && !curr.getFirstName().equals(firstName)){
                    System.out.println("Entry not found! Returning to main menu...");
                    printMenu();
                }
            }
                ...
                for (int i = 0; i < Book.size(); i++) {
                    ...
                    else if(i==Book.size()-1 && !Book.get(i).getLastName().equals(lastName)){
                        System.out.println("Entry not found! Returning to main menu...");
                        printMenu();
                    }
                }
                ...
                for (int i = 0; i < Book.size(); i++) {
                    ...
                    if(i==Book.size()-1 && !Book.get(i).getPhoneNumber().equals(phone)){
                        System.out.println("Entry not found! Returning to main menu...");
                        printMenu();
                    }
                }
                ...
                for (int i = 0; i < Book.size(); i++) {
                    ...
                    if(i==Book.size()-1 && !curr.getEmail().equals(email)){
                        System.out.println("Entry not found! Returning to main menu...");
                        printMenu();
                    }
                }
